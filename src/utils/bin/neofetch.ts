...
const getInfo = () => {
  ...
  message += `<span style="color: ${mainColor}">Shell</span>: codedeeply-web\n`;
  ...
  message += `<span style="color: ${mainColor}">Forked from</span>: <a href="https://github.com/m4tt72/terminal">https://github.com/m4tt72/terminal</a>\n`;
